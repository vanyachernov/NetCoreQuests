...
namespace Quests.Infrastructure.Migrations
{
    ...
    [Migration("20250209181943_AddRatingAndDifficutly")]
    partial class AddRatingAndDifficutly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quests.Domain.TestDirectory.Root.Test", b =>
                {
                    b.OwnsOne("Quests.Domain.TestDirectory.ValueObjects.CreatedOrUpdatedAt", "CreatedAt", b1 =>
                        {
                    ...
                    b.OwnsOne("Quests.Domain.TestDirectory.ValueObjects.CreatedOrUpdatedAt", "UpdatedAt", b1 =>
                        {
                            b1.Property<Guid>("TestId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
